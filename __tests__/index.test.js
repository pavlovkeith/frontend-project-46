...
const cases = [
  ...
  ['__fixtures__/file1.yaml', '__fixtures__/file2.yaml', readFile('stylishTest.txt')],
  ['__fixtures__/file1.json', '__fixtures__/file2.json', readFile('stylishTest.txt'), 'stylish'],
  ['__fixtures__/file1.yaml', '__fixtures__/file2.yaml', readFile('stylishTest.txt'), 'stylish'],
  ['__fixtures__/file1.json', '__fixtures__/file2.json', readFile('plainTest.txt'), 'plain'],
  ['__fixtures__/file1.yaml', '__fixtures__/file2.yaml', readFile('plainTest.txt'), 'plain'],
  ['__fixtures__/file1.json', '__fixtures__/file2.json', readFile('jsonTest.txt'), 'json'],
  ['__fixtures__/file1.yaml', '__fixtures__/file2.yaml', readFile('jsonTest.txt'), 'json'],
];
